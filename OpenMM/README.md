# Installation instructions for OpenMM version 7.7 on Discovery (V100 GPU + Skylake_AVX512 CPU):
These instructions are for the installation for OpenMM version 7.7 on the Discovery cluster with Miniconda, GNU 10.1.0 compilers and OpenMPI v. 4.1.0 with CUDA support version 11.2. The installation script will also intall the dependency package Swig v. 3.0.5. 
